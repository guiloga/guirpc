...
def foobar_sum(x_request):
    """
    This is an example of a service callback implementation
    with :class:`JsonSerializer` as a request and response serializer types.
    A :class:`JsonSerializer` encapsulates content
    as an object of type :class:`dict`.
    ...
    try:
        ...
        response = ProxyResponse(
            500,
            error_message="[ServerError] An unexpected error occurred "
...
def foobar_count(x_request):
    """
    This is an example of a service callback implementation
    with :class:`TextSerializer` as a request and response serializer types.
    A :class:`TextSerializer` encapsulates content
    as an object of type :class:`str`.
